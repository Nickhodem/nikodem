...
const links = [
  { icon: Mail, label: "email", href: "mailto:nickhodem@gmail.com", external: false },
  { icon: Github, label: "github", href: "https://github.com/nickhodem", external: true },
  { icon: Linkedin, label: "linkedin", href: "https://linkedin.com/in/nikodem-pankiewicz", external: true },
];
      ...
      <div className="max-w-3xl mx-auto text-center relative">
        <RevealSection>
          ...
          <h3 className="text-3xl md:text-5xl font-heading font-bold text-foreground mb-4 leading-tight">
            Let's <span className="text-gradient">build</span> the future.
          </h3>
